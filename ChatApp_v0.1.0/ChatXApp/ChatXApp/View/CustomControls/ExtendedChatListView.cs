...
namespace ChatXApp.View.CustomControls
{
    public class ExtendedChatListView : ListView
    {
        
        public ExtendedChatListView() : this(ListViewCachingStrategy.RecycleElement)
        {

        }

        public ExtendedChatListView(ListViewCachingStrategy cachingStrategy) : base(cachingStrategy)
        {
        ...
        public static readonly BindableProperty TappedCommandProperty =
            BindableProperty.Create(nameof(TappedCommand), typeof(ICommand), typeof(ExtendedChatListView), default(ICommand));
        ...
        public static readonly BindableProperty ItemAppearingCommandProperty =
            BindableProperty.Create(nameof(ItemAppearingCommand), typeof(ICommand), typeof(ExtendedChatListView), default(ICommand));
        ...
        public static readonly BindableProperty ItemDisappearingCommandProperty =
         BindableProperty.Create(nameof(ItemDisappearingCommand), typeof(ICommand), typeof(ExtendedChatListView), default(ICommand));
        ...
        {
            var listView = (ExtendedChatListView)sender;
            if (e == null) return;
